...
#define STRING_CONFIG_H_AUTHOR "(Philippe Rodier, JGAurora A5X Stock)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "JGAurora A5Xr"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // JGAurora A5X Stock hotend for 200°C, 8 cycles (Philippe Rodier)
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Stock JGAurora A5X Stock Bed Tuned for 70°C, 8 cycles
